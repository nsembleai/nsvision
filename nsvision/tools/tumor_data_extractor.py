...
# parser.add_argument(
#     "-e", "--extension", default="jpg", help='Extension of the converted image"'
# )
...
#     if zip_file is None:
#         raise ImportError("zipfile is required" "Install using `pip install zipfile`")
...
#         os.path.dirname(dst_dir), "brain_tumor_data/" + tumor_name
#     )
...
#     print(
#         "Data has been saved in this directory",
#         os.path.join(os.path.dirname(dst_dir), "brain_tumor_data"),
#     )
...
#     print(
#         "Converting all the .mat file in the given",
#         f"zip folder path: {args.base_dir}\n",
#         sep="\n",
#     )
