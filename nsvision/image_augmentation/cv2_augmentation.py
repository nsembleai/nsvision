...
#     import cv2
# except ImportError:
#     raise ImportError("Requires cv2 library, Please install opencv library")
...
#     def flip_image(
#         self, flip_angle=0
#     ):  # flip the image around horizontally or vertically
...
#             cv2.imwrite(
#                 os.path.join(
#                     self.dst_path, image_name + "_flip" + str(flip_angle) + image_ext
#                 ),
#                 flipimage,
#             )
#         else:
...
#                     os.path.join(
#                         self.dst_path,
#                         image_name + "_flip" + str(flip_angle) + image_ext,
#                     ),
#                     flipimage,
#                 )
...
#                 os.path.join(
#                     self.dst_path,
#                     image_name + "_bilateral" + str(a) + str(b) + str(c) + image_ext,
#                 ),
#                 bilateral,
#             )
#         else:
...
#             cv2.imwrite(
#                 os.path.join(
#                     self.dst_path, image_name + "_average" + str(x) + image_ext
#                 ),
#                 average,
#             )
#         else:
...
#             cv2.imwrite(
#                 os.path.join(
#                     self.dst_path, image_name + "_resize" + str(w) + str(h) + image_ext
#                 ),
#                 resizeimage,
#             )
#         else:
...
#                     os.path.join(
#                         self.dst_path,
#                         image_name + "_resize" + str(w) + str(h) + image_ext,
#                     ),
#                     resizeimage,
#                 )
#         return resizeimage
...
#             cv2.imwrite(
#                 os.path.join(
#                     self.dst_path, image_name + "_rotate" + str(deg) + image_ext
#                 ),
#                 rotateimage,
#             )
#         else:
...
#             cv2.imwrite(
#                 os.path.join(
#                     self.dst_path, image_name + "_gausian" + str(blur) + image_ext
#                 ),
#                 gausianimage,
#             )
#         else:
...
#             cv2.imwrite(
#                 os.path.join(
#                     self.dst_path, image_name + "_median" + str(shift) + image_ext
#                 ),
#                 medianimage,
#             )
#         else:
